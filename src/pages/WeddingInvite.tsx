  ...
  return (
    <div className="relative min-h-screen bg-[white] text-stone-800">
      ...
      {overlayVisible && (
        <button
          type="button"
          className={`overlay-enter-card fixed inset-0 z-[200] flex cursor-pointer flex-col items-center justify-between overflow-hidden px-2 py-12 outline-none focus:ring-0 ${overlayExiting ? "overlay-exiting" : ""
            }`}
          style={{
            background: `linear-gradient(180deg, rgba(0,0,0,0.12) 0%, transparent 35%, transparent 65%, rgba(0,0,0,0.1) 100%), url("${BASE}backgound-1.png") center center / cover no-repeat`,
          }}
          onClick={startMusic}
