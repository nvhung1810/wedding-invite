...
export function WeddingInvite() {
  ...
  return (
    <div className="relative min-h-screen bg-[white] text-stone-800">
      <audio ref={audioRef} src={BG_MUSIC_SRC} loop playsInline />
      <FallingBears />
      <ScrollArea className="relative z-10 h-screen w-full">
        <div className="mx-auto max-w-[420px]">
          ...
          <section
            ...
            style={{
              background:
                'url("https://content.pancake.vn/1/s840x1600/fwebp/65/3c/aa/be/35e135afc2c6420bc52abd8fb3768c346420d9efa7b879cd959ee353.png") center center / cover no-repeat content-box border-box',
              minHeight: "320px",
              height: "780px",
            }}
          >
            ...
            <h2
              className="mt-2 text-[2.5rem] tracking-wide font-['Great_Vibes',cursive]"
          ...
          >
            ...
            {/* Tiệc cưới Nhà Trai */}
            <Card className="mt-8 mx-6 rounded-2xl border border-solid border-[rgba(229,231,235,1)] bg-[rgba(0,95,188,0.17)] shadow-sm content-visibility-section">
              ...
              <CardFooter className="justify-center">
                ...
                >
                  ...
                  <DialogContent className="sm:max-w-md rounded-xl bg-white shadow-lg">
                    <DialogHeader>
                      <DialogTitle className="font-['Allura',cursive] text-3xl text-stone-800 text-center">
                        {t("gift.modalTitle")}
                      </DialogTitle>
                    </DialogHeader>
            ...
            {/* Tiệc cưới Nhà Gái */}
            <Card className="mt-6 mx-6 rounded-2xl border border-solid border-[rgba(229,231,235,1)] bg-[rgba(0,95,188,0.17)] shadow-sm content-visibility-section">
              <CardHeader className="text-center gap-0">
                <CardTitle
                  className="text-lg tracking-wide text-amber-900"
                  style={{ color: "rgb(0, 50, 99)" }}
